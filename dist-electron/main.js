import require$$1$5, { app, BrowserWindow, dialog } from "electron";
...
const createMainWindow = () => {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    mainWindow.loadFile(path$i.join(RENDERER_DIST, "index.html"));
  }
};
  ...
  mainExports.autoUpdater.on("update-downloaded", () => {
    ...
    if (mainWindow) {
      dialog.showMessageBox(mainWindow, {
        ...
        if (result.response === 0) mainExports.autoUpdater.quitAndInstall();
      });
    }
  });
